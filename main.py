...
# from collectors.instagram_collector import fetch_instagram  (Not working)
# from collectors.tiktok_collector import fetch_tiktok         (Not working)
...
def run_pipeline():
    ...
    data.extend(fetch_quora("osint", 5))
